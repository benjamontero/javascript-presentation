...
var masa = "masa";
var salsaDeTomate = "salsa de tomate";
var quesoMuzzarella = "queso muzzarella";`}
            </code>
          </pre>
        </div>
      </div>
...
// La función hace uso de las variables globales directamente.
    ...
    console.log("¡Pizza de muzzarella lista para hornear!");}`}
      ...
      <div className="scope-card-empleados">
        ...
        <h3>Cocineros</h3>
        <p>
         Los cocineros pueden acceder correctamente a todas las variables fuera de la funcion y tienen todas las herramientas para ejecutar sin problemas: <code>hacerPizzaMuzzarella()</code>
        </p>
      </div>
      <button>
